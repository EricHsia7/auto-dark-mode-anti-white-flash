export function initialize(): void {
  ...
  styleTagElement.textContent = `@media (prefers-color-scheme: dark) {body:empty, html:empty {background-color:#161616;}} @media (prefers-color-scheme: light) {body:empty, html:empty {background-color:#ffffff;}} .auto_dark_mode_anti_white_flash_mask {position:fixed;top:0px;left:0px;width:100%;height:100%;user-select:none;-webkit-user-select:none;z-index:999999;opacity:1;transition:opacity 0.8s;display:flex;justify-content:center;align-items:center;background-color:transparent;color:#888888;font-size:12px;font-family:sans-serif;font-weight:300;backdrop-filter:brightness(50%);-webkit-backdrop-filter:brightness(50%);} .auto_dark_mode_anti_white_flash_mask_hide {opacity:0;}`;
